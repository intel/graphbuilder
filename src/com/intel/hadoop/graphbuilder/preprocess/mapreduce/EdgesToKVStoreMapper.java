...
public class EdgesToKVStoreMapper<VidType extends WritableComparable<VidType>>
    extends MapReduceBase implements
    Mapper<LongWritable, Text, VidType, PairListType> {

  private static final Logger LOG = Logger.getLogger(EdgesToKVStoreMapper.class);
