 ...
 * @see GraphTokenizer
 */
public class XMLTokenizerMR {

  private static final Logger LOG = Logger.getLogger(XMLTokenizerMR.class);
   ...
   * @param inputformat
   */
  public XMLTokenizerMR(GraphTokenizer tokenizer, InputFormat inputformat) {
    conf = new JobConf(XMLTokenizerMR.class);
  ...
  public void run(String[] inputpaths, String outputpath) throws Exception {
    // Mapper and Reducer
    conf.setMapperClass(XMLTokenizerMapper.class);
    conf.setReducerClass(XMLTokenizerReducer.class);
    ...
    LOG.info("=========== Job: Convert XML to CSV from raw data ===========");
