...
public class TitanWriterMRChainTest extends TestMapReduceDriverUtils {
    ...
    public void test_hbase_to_vertices_to_titan_MR() throws Exception {
        ...
        PowerMockito.doReturn(900L).doReturn(901L).doReturn(902L).when
                (spiedTitanMergedGraphElementWrite).getVertexId(
        ...
        assertEquals("check NUM_EDGES counter", gbVertexMapReduceDriver
                .getCounters().findCounter(spiedVerticesIntoTitanReducer
    ...
    @Test
    public void test_hbase_vertices_to_titan_MR_two_hbase_results() throws
            Exception {
        ...
        PowerMockito.doReturn(900L).doReturn(901L).doReturn(902L)
                ...
                .when(spiedTitanMergedGraphElementWrite)
